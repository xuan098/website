...
<div class="row" class="container">
    ...
    <!--显示用户信息用于修改用户信息-->
    <!--删除用户-->
    <div style=" padding-right: 0px; height: auto;width:80%;background-color: ; border:0px solid #000;" id="one.three" class="col-md-offset-2" >
        <table class='table table-hover table-bordered table-striped'>
            ...
            <td>$row[address]</td>
            <td><a href='admin_del.php?id=$row[id]'>delete</a></td>
            </tr>
            </tbody>";
            }
